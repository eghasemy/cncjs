...
class FluidNC extends PureComponent {
    ...
    // https://github.com/grbl/grbl/wiki/Interfacing-with-FluidNC
    // FluidNC v0.9: BLOCK_BUFFER_SIZE (18), RX_BUFFER_SIZE (128)
    // FluidNC v1.1: BLOCK_BUFFER_SIZE (16), RX_BUFFER_SIZE (128)
    plannerBufferMax = 0;
